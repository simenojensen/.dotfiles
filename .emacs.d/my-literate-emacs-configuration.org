...
Python setup with [[https://docs.conda.io/en/latest/miniconda.html][miniconda]].
...
- Makes Python shells, interactive shells, eshell, anaconda-mode, and so on aware of conda environments
