...
- [[#editing][Editing]]
  ...
  - [[#mytoggle-comment-on-line][=my/toggle-comment-on-line=]]
...
- [[#added-functionality][Added Functionality]]
  ...
  - [[#myrename-file-and-buffer][=my/rename-file-and-buffer=]]
  - [[#goto-match-paren][=goto-match-paren=]]
...
- Set frame title to =[user@hostname]*BufferName*=
...
[[http://www.dr-qubit.org/undo-tree.html][More Information]]
...
I am using =company= for autocompletion.
...
Follow [[https://wfbroderick.com/2019-Jan-01.html][this guide]] to set up with conda and company.
...
[[https://www.emacswiki.org/emacs/ShowParenMode][More Information]]
...
The Emacs IPython Notebook (=EIN=) package provides a Jupyter Notebook client and integrated REPL (like SLIME) in Emacs.

[[http://millejoh.github.io/emacs-ipython-notebook/][More Information]]
