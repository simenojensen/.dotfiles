...
- [[#performance-optimization][Performance Optimization]]
  ...
  - [[#disable-regexps-when-parsing-filenames-during-startup][Disable regexps when Parsing Filenames during Startup.]]
...
- [[#package-management][Package Management]]
  ...
  - [[#define-package-repositories][Define Package Repositories]]
  - [[#security][Security]]
...
- [[#functionality][Functionality]]
  ...
  - [[#reload-emacs-configurations][Reload Emacs Configurations]]
  - [[#iedit][=iedit=]]
...
- [[#epilogue][Epilogue]]
  - [[#close-file-name-handler-alist-expression][Close =file-name-handler-alist= Expression]]
...
Installing un-signed code into the editor that was downloaded over an unencrypted, unauthenticated transport like HTTP, might lead to installing malware.
[[https://glyph.twistedmatrix.com/2015/11/editor-malware.html][More Information]]
...
#+BEGIN_SRC emacs-lisp
  (setq backup-directory-alist '(("." . "/Users/simenojensen/.emacs.d/backups")))
#+END_SRC
...
Set the python interpreter to =IPython=.
[[https://www.emacswiki.org/emacs/PythonProgrammingInEmacs][More Information]]
...
Set run python script keybinding.
[[https://github.com/jorgenschaefer/elpy/issues/69][More Information]]
